...
var vm = function () {
    ...
    self.displayName = 'Olympians Details:';
    ...
    self.Medals = ko.observableArray([
        {
                "MedalId": ko.observable(''),
                "MedalName": ko.observable(''),
    ...
    self.activate = function (id) {
        ...
        ajaxHelper(composedUri, 'GET').done(function (data) {
            ...
            self.Name(data.Name);
            if (data.Photo == null) {
                self.Photo('../Images/nevescard.webp')
            } else {
    ...
    $("#searchArgs").autocomplete({ 
        ...
        select: function(event, ui) {
           window.location.href = "./AtletasDetalhado.html?id=" + ui.item.value;
        },
    });
